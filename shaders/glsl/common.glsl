...
#define SUN_PATH_ROTATION -30.0 // rotation of the sun in z direction
...
#define MIE_COEFFICIENT 8e-7 // 2e-7 = 0.0000005
...
float cphase(float cost){
	float mie1 = mphase(cost, VOLUMETRIC_CLOUD_MIE_DIRECTIONAL_G), mie2 = mphase(cost, 0.0);
